...
public class Task<TResult> {
	 ...
	 */
	private static void setUnobservedExceptionHandler(Task.UnobservedExceptionHandler eh) {
	...
	/**
	 * @deprecated Please use {@link TaskCompletionSource ()} instead.
	 */
	public static <TResult> TaskCompletionSource create(Call<TResult> call) {
		return new TaskCompletionSource<>(call);
	}
	...
	private static <TResult> Task<TResult> forResult(TResult value) {
		if (value == null) {
		...
		TaskCompletionSource<TResult> tcs = new TaskCompletionSource<>(null);
		tcs.setResult(value);
		return tcs.getTask();
	}
	 ...
	 */
	private static <TResult> Task<TResult> forError(Exception error) {
		TaskCompletionSource<TResult> tcs = new TaskCompletionSource<>(null);
		tcs.setError(error);
		return tcs.getTask();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	private static <TResult> Task<TResult> cancelled() {
	...
	public static Task<Void> delay(long delay) {
		return delay(delay, MenigaExecutors.scheduled(), null);
	}
	...
	static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
		...
		final TaskCompletionSource<Void> tcs = new TaskCompletionSource<>(null);
	...
	public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
		...
		final TaskCompletionSource<TResult> tcs = new TaskCompletionSource<>(null);
		try {
	...
	public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
		...
		final TaskCompletionSource<Task<TResult>> firstCompleted = new TaskCompletionSource<>(null);
	...
	public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
		...
		final TaskCompletionSource<Task<?>> firstCompleted = new TaskCompletionSource<>(null);
		final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
	...
	static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
		...
		final TaskCompletionSource<Void> allFinished = new TaskCompletionSource<>(null);
	 ...
	 * a task continuation.
	 */
	private Task<Void> continueWhile(final Callable<Boolean> predicate,
	                                 final Continuation<Void, Task<Void>> continuation, final Executor executor,
	                                 final CancellationToken ct) {
	...
	public <TContinuationResult> Task<TContinuationResult> continueWith(
			...
			final CancellationToken ct) {
		boolean completed;
		final TaskCompletionSource<TContinuationResult> tcs = new TaskCompletionSource<>(null);
		synchronized (lock) {
	 ...
	 * {@link java.lang.Exception} or cancellation.
	 */
	private <TContinuationResult> Task<TContinuationResult> onSuccess(
			final Continuation<TResult, TContinuationResult> continuation, Executor executor,
			final CancellationToken ct) {
	 ...
	 * {@link java.lang.Exception}s or cancellation.
	 */
	private <TContinuationResult> Task<TContinuationResult> onSuccessTask(
